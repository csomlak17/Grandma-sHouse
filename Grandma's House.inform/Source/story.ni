...
When play begins: say "You are a small ten-year-old having a sleep over at grandma's house. You helped her make homemade chocolate cookies during the day and couldn't get enough of them after dinner. Of course bed time is way too early, and you just had cookies so you lay in your bed awake, wondering about the cookies down stairs. Is there any way you could get to them?"
...
Broken bike horn is a thing in bedroom. The description is "The ringer is broken, however it seems like it could still be attached to any poles about as thick as the bedside table's legs with the command combine."
...
Understand "Sheet" as sheets.

Floor is scenery in bedroom. The description is "Just wood."

Ringer is scenery in bedroom. The description is "Just broken."
...
Understand "crank [something] open with [something]" as unlocking it with.
Glass is a door. Glass is down of bedroom. Glass is locked and lockable. The printed name of glass is "Window". The wrench unlocks glass. The description of glass is "Closed with a cracking handle, but it's stuck, you probably need a wrench in order to crank it open."
Understand "Window" as Glass.

Handle is scenery. The description is "Just a spinning, stuck handle."

Despair is a thing in Bedroom. The description is "I can just imagine breaking off a nice piece with lots of chocolate chunks... there's probably something else that can break like a cookie in this room...". 
...
Imaginary cookie is a thing in Bedroom. Imaginary cookie is undescribed. The description is "I can just imagine breaking off a nice piece with lots of chocolate chunks... there's probably something else that can break like a cookie in this room...". 
...
Instead of taking hook:
	say "It's attached to the table, which is going to be good for getting you down stairs, so I wouldn't undo it".
...
Hallway is a room. Hallway is west of Orange. The description is "There are hallway windows on the side of the Hallway opposite of your door illuminating the objects in the room. [if player is not carrying wooden stool] There's a small wooden stool grandma stands on to clean the windows since they're too tall for her. [end if] There's some old medals hanging on the wall by the bedroom door. Underneath the medals there is a table with a lamp. South of here the hallway extends to grandma's door. You also see the Hallway door which leads to the stairs, leading down to the kitchen!"

[Took a lot of research to figure out how to make supporters and make it portable]
...
Medal is a thing in Hallway. Medal is undescribed. The description of medal is "It's a nice medal, bronze. Furthermore, the strap that goes around the neck seems thin enough to pass through an attached bike horn, but wide enough to let sheets slide through."
...
Spare bell is a thing in Grandmas entrance. The description of spare bell is "I heard the cat playing with it earlier. It was pretty loud so I wouldn't go near it if I were you.".
Understand "bell" as spare bell. 
Instead of taking spare bell:
	say "you reach for the bell and in the process of picking it up it rings alerting grandma. You're in big trouble for sneaking around a night!";
	end the story finally. 
	
Rubber duck is a thing in Grandmas entrance. The description of rubber duck is "I heard the cat playing with it earlier. It was pretty loud so I wouldn't go near it if I were you.".
Understand "duck" as rubber duck. 
Instead of taking rubber duck:
	say "you reach for the small duck and while picking it up you squeeze a bit too hard... You're in big trouble for sneaking around a night!";
	end the story finally. 
...
Woods is a room. Woods is east of Landing zone. The description is "It's just a plain field. [if leaves are in woods] Oh look it's the cat, he's playing with a pile of leaves. I love the cat. What's that? Did I just hear the cat speak to me??"
...
Bright is a thing in light zone. The printed name is "Light". The description is "Motion activated, and bright enough to wake up grandma. Advance with caution."
...
[Again a lot of instead rules which allow the action of stapling to give hints on both the combining puzzle, the stapling puzzle, and require the right things for this action]
Understand "staple [something]" as smelling. 
Instead of smelling:
	if noun is leaves:
		if player has stapler:
			if player is in Light zone:
				say "You staple the leaves to the wall blocking the light from reaching upstairs. Now safely go to the porch up north!";
	...
	if noun is sheets:
		say "These sheets are way too thick to be stapled. Try combining sheets to something!";	
	otherwise:
...
Instead of going to front porch:
	...
	otherwise:	
		if leaves are in light zone:
			...
			now player is in front porch;
		otherwise:
			say "The light turns on, and grandma's six since wakes her up... Looks like you'll never even see cookies at grandma's house again.";
			end the story finally.	
...
Cookies are a thing in kitchen. Cookies are undescribed. The description is "Delicious amazing, soft, chocolate chip cookies!"
Understand "eat [something]" as taking.
Instead of taking cookies:
	if player is not carrying bright:
		say "You search the counters furiously feeling for the cookies and then you nock grandma's favorite vase on the floor!!! Right after the falling sound you see an upstairs light turn on... You were so close, you just needed a light!";
		end the story finally;
	otherwise:
		if player is on wooden stool:
			say "You reach up safely feel the crumbly, soft, mouthwatering, delicious cookies. Nothing could have made this day better!";
			end the story finally;
		otherwise:
			say "You can see them now, but you can't reach them!".		
...
Lift sheets, 
take stapler, 
unlock orange door with spare key, 
w,
take medals, 
take wooden stool, 
s, 
...
n, 
e, 
crank open window with wrench, 
combine bedside table with broken bike horn,
combine hook with medal, 
combine hanger with sheets, 
open window, 
down, 
e, 
take leaves, 
